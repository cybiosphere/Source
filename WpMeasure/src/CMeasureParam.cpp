...
CMeasureParam::CMeasureParam(CGenericParam* pParam, int period, int id, MeasureType_e type)
:CMeasure(period, id, pParam->getMin(), pParam->getMax(), type)
{
  m_pParam = pParam;
}
