...
//---------------------------------------------------------------------------
// METHOD:       CReactionAttack::CReactionAttack
//  
...
// REMARKS:      None
//---------------------------------------------------------------------------
CReactionAttack::CReactionAttack(CBrainAnimal*  pBrain, double successFactor, double failureFactor, int relLayer)
:CReaction(successFactor, failureFactor, UID_BASE_REACT_ATTACK + relLayer, 1)
{
  m_pBrain        = pBrain;
...
//---------------------------------------------------------------------------
// METHOD:       CReactionAttack::ExecuteAction
//  
...
// REMARKS:      None
//---------------------------------------------------------------------------
void CReactionAttack::ExecuteAction(ReactionIntensityType_e intensity)
{
