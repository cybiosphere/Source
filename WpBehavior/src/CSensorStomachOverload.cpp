...
//===========================================================================
// FILE: CSensorStomachOverload.cpp
//   
// GENERAL DESCRIPTION:
...
//---------------------------------------------------------------------------
// METHOD:       CSensorStomachOverload::CSensorStomachOverload
//  
...
// REMARKS:      None
//---------------------------------------------------------------------------
CSensorStomachOverload::CSensorStomachOverload(CBrainAnimal* pBrain, double weightRate)
:CSensor(weightRate, UID_BASE_SENS_STOMACH_FULL)
{
  m_pBrain = pBrain;
  m_Label = "Stomach overload";
}

CSensorStomachOverload::~CSensorStomachOverload()
{
...
//---------------------------------------------------------------------------
// METHOD:       CSensorStomachOverload::UpdateAndGetStimulationTable
//  
...
//---------------------------------------------------------------------------
// METHOD:       CSensorStomachOverload::GetSubCaptorLabel
//  
