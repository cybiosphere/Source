...
//===========================================================================
// FILE: CReactionTurnHeadLeft.cpp
//   
// GENERAL DESCRIPTION:
//         This CLASS represents an action turn head left
//     
...
//---------------------------------------------------------------------------
// METHOD:       CReactionTurnHeadLeft::CReactionTurnHeadLeft
//  
...
// REMARKS:      None
//---------------------------------------------------------------------------
CReactionTurnHeadLeft::CReactionTurnHeadLeft(CBrainAnimal*  pBrain, double successFactor, double failureFactor)
:CReaction(successFactor, failureFactor, UID_BASE_REACT_TURNHEADLEFT, 1)
{
  m_pBrain = pBrain;
  m_Label  = "Turn_head_left";
}
...
//---------------------------------------------------------------------------
// METHOD:       CReactionTurnHeadLeft::ExecuteAction
//  
...
//---------------------------------------------------------------------------
void CReactionTurnHeadLeft::ExecuteAction(ReactionIntensityType_e intensity)
{
