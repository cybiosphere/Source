...
#if !defined(SENSORVIEWFAR_H)
#define SENSORVIEWFAR_H
...
} EntityViewFarWeight_t;


//===========================================================================
//                                    CLASS            
//===========================================================================
class DLL_CYBIOCORE_API CSensorViewFar : public CSensor  
{
//===========================================================================
// Attributes 
//===========================================================================
...
private:
  ...
  EntityViewFarWeight_t m_pEntityViewFarTab[MAX_FOUND_ENTITIES];
...
private:
  ...
  EntityViewFarWeight_t m_followedEntityWeight;
