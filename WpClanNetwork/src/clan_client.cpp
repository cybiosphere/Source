...
void Client::on_event_biotop_updateentityposition(const NetGameEvent &e) 
{
  ...
  Point_t pos;
  pos.x          = e.get_argument(2);
  pos.y          = e.get_argument(3);
  int layer      = e.get_argument(4);
  int dir        = e.get_argument(5);
  int speed      = e.get_argument(6);
  float weight   = e.get_argument(7);
  int reactIndex = e.get_argument(8);
  int status     = e.get_argument(9);
